...
$this->params['breadcrumbs'][] = array(
    'label'=> 'Menejerni O\'gartirish', 
    'url'=>'#',
    'template' => "{link}",
);

$this->title = "Smartbook DMS – Menejerni O'gartirish";

?>
<!-- BEGIN: Wizard Layout -->
<div class="intro-y box pb-10 pt-3 sm:pb-20 sm:pt-3 mt-5">
    <div class="px-5 mt-10">
        <div class="font-medium text-center text-lg">Menejerni O'gartirish</div>
        <div class="flex justify-center">
            <div class="text-gray-600 text-center mt-2 md:w-1/3">Menejerning ma'lumotlari o'zgarganda, uning hisob qaydnomasi barcha qurilmalaridan chiqib ketadi va u yana tizimga kirishi kerak. Agar siz parolni o'zgartirgan bo'lsangiz, uni eslang va kelajakda menejerga bering.</div>
        </div>
    </div>
    <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200 dark:border-dark-5">
        ...
        <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
            ...
            <div class="intro-y col-span-12 sm:col-span-6">
                <?= $form->field($model, 'password', ['labelOptions' => ['class' => 'mb-2 block']])->textInput(['class' => 'input w-full border flex-1', 'value' => ''])->label("Yangi Parol")?>
            </div>
            <div class="intro-y col-span-12 sm:col-span-6">
            ...
            <div class="intro-y col-span-12 flex items-center justify-center sm:justify-center mt-5">
                ...
                <button type="submit" class="button justify-center block bg-theme-1 text-white ml-2">O'zgartirish</button>
            </div>
            <?php ActiveForm::end()?>
        </div>
    </div>
