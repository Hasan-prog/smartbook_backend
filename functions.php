        ...
        if ($status == 'delivered') {
            ...
            <div class="dropdown-box w-32">
                <div class="dropdown-box__content box dark:bg-dark-1"> 
                    ...
                    <button data-status="canceled" data-style="bg-theme-6" class="button button--sm inline-block bg-theme-6 text-white mx-auto w-32 text-center flex items-center justify-center mb-1">Qaytargan</button>
                </div>
            </div>
            <?php
        }
